...
const NumbersPanel = (props) => {
    ...
    return (
        <div className='numbers_panel_container'>
            {arrayOfNumberBtn.map(number => <NumberBtn handleCalculation={props.changeCalculation} operatorGetter={props.operatorGetter} curNumberGetter={props.curNumberGetter} prevNumberGetter={props.prevNumberGetter} lastBtnGetter={props.lastBtnGetter} lastBtnSetter={props.lastBtnSetter} number={number} />)}
